...
public interface AuthenticationMapper {
    ...
    public User searchDataByOpenid(@Param("openid") String openid);
    ...
    public List<MenuTree> getChildrenMenuTreeByUser(@Param("masterid") String masterid,@Param("userid") String userid);
